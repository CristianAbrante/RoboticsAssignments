...
T111 = matriz_T(d[2],th[2],a[2],al[2])
T112 = matriz_T(d[3],th[3],a[3],al[3])
...
T011 = np.dot(T01,T111)
T02  = np.dot(T011,T112)
T03  = np.dot(T02,T23)
...
muestra_origenes([o00, o010, o10, o110, o20, o30, [[o410],[o420]]], oEF0)
muestra_robot   ([o00, o010, o10, o110, o20, o30, [[o410],[o420]]], oEF0)
input()
